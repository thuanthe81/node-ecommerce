...
async function main() {
  ...
  const shippingMethods = [
    ...
    },
    {
      ...
      nameVi: 'Vận chuyển qua đêm',
      descriptionEn: 'Next business day delivery',
      descriptionVi: 'Giao hàng ngày làm việc tiếp theo',
      carrier: 'Express Delivery',
      baseRate: 25.0,
      estimatedDaysMin: 1,
      estimatedDaysMax: 1,
    ...
    {
      methodId: 'international_standard',
      nameEn: 'International Standard',
      nameVi: 'Quốc tế tiêu chuẩn',
      descriptionEn: 'Delivery in 10-15 business days',
      descriptionVi: 'Giao hàng trong 10-15 ngày làm việc',
    ...
    {
      methodId: 'international_express',
      nameEn: 'International Express',
      nameVi: 'Quốc tế nhanh',
      descriptionEn: 'Delivery in 5-7 business days',
      descriptionVi: 'Giao hàng trong 5-7 ngày làm việc',
      carrier: 'DHL/FedEx',
      baseRate: 50.0,
