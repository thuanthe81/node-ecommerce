...
export const SvgTwitter = ({ tooltip = COMMON_TOOLTIPS_KEYS.TWITTER, tooltipPlacement, ...props }: SvgProps) => (
  <SvgWithTooltip tooltip={tooltip} tooltipPlacement={tooltipPlacement} {...props}>
    <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const SvgTikTok = ({ tooltip = COMMON_TOOLTIPS_KEYS.TIKTOK, tooltipPlacement, ...props }: SvgProps) => (
  <SvgWithTooltip tooltip={tooltip} tooltipPlacement={tooltipPlacement} {...props}>
    <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
...
export const SvgZalo = ({ tooltip = COMMON_TOOLTIPS_KEYS.ZALO, tooltipPlacement, ...props }: ImageProps & SvgTooltipProps) => {
  const tooltipContent = useTooltipContent(tooltip);
...
export const SvgWhatsApp = ({ tooltip = COMMON_TOOLTIPS_KEYS.WHATSAPP, tooltipPlacement, ...props }: SvgProps) => (
  <SvgWithTooltip tooltip={tooltip} tooltipPlacement={tooltipPlacement} {...props}>
    <svg fill="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
