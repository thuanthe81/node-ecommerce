...
import { SvgClose, SvgAlertTriangle, SvgXCircle, SvgInfo, SvgSpinnerLoading } from '@/components/Svgs';
          ...
          <div id="cancellation-modal-description" className="space-y-4">
            ...
            {!error && (
              <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                <div className="flex">
                  <SvgAlertTriangle className="w-5 h-5 text-yellow-400 mt-0.5 mr-3 flex-shrink-0" />
            ...
            {error && (
              <div className="bg-red-50 border border-red-200 rounded-lg p-4">
                <div className="flex">
                  <SvgXCircle className="w-5 h-5 text-red-400 mt-0.5 mr-3 flex-shrink-0" />
            ...
            {error && isRetryable && (
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                <div className="flex">
                  <SvgInfo className="w-5 h-5 text-blue-400 mt-0.5 mr-3 flex-shrink-0" />
          ...
          <div className="flex flex-col-reverse sm:flex-row sm:justify-end sm:space-x-3 space-y-3 space-y-reverse sm:space-y-0">
            ...
            {showRetryButton && (
              ...
              >
                {isLoading ? (
                  <>
                    <SvgSpinnerLoading className="animate-spin -ml-1 mr-2 h-4 w-4 text-white" />
                    {t('retryOperation')}
                  </>
                ) : (
                  t('retryOperation')
