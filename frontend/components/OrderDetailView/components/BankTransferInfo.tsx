...
import { SvgLock, SvgAlertTriangle, SvgRefresh, SvgInfo, SvgCreditCard, SvgQrCode } from '@/components/Svgs';
    ...
    >
      <div className="flex items-center gap-3 mb-4">
        <div
          ...
          aria-hidden="true"
        >
          <SvgLock className="w-6 h-6 sm:w-7 sm:h-7 text-white" />
        </div>
        <h2
        ...
        >
          ...
          <div className="bg-white border border-yellow-200 rounded p-4 mt-4">
            <p className="text-sm text-gray-700 flex items-start gap-2">
              <SvgInfo className="w-5 h-5 text-blue-600 flex-shrink-0 mt-0.5" />
        ...
        <>
          ...
          >
            <div className="flex items-center gap-2 mb-6">
              <SvgCreditCard className="w-6 h-6 text-blue-600" />
              <h3
              ...
              {bankSettings.qrCodeUrl && (
                ...
                >
                  <div className="flex items-center justify-center gap-2 mb-3">
                    <SvgQrCode className="w-5 h-5 text-blue-600" />
                    <h3
                      id="qr-code-heading"
