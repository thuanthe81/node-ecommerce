...
export function useShippingMethodForm(
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const dataToSend = {
      ...
      weightThreshold: formData.weightThreshold > 0 ? formData.weightThreshold : undefined,
      weightRate: formData.weightRate > 0 ? formData.weightRate : undefined,
      freeShippingThreshold: formData.freeShippingThreshold > 0 ? formData.freeShippingThreshold : undefined,
