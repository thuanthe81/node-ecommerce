...
import { SvgCheck, SvgAlertTriangle, SvgCheckCircle, SvgInfo } from '@/components/Svgs';
          ...
          {syncResults.some(r => !r.success) ? (
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg">
              <div className="flex items-start">
                <SvgAlertTriangle className="w-5 h-5 text-yellow-600 mr-3 mt-0.5 flex-shrink-0" />
            ...
            <div className="p-4 bg-green-50 border border-green-200 rounded-lg">
              <div className="flex items-start">
                <SvgCheckCircle className="w-5 h-5 text-green-600 mr-3 mt-0.5 flex-shrink-0" />
            ...
            <div className="bg-white rounded-lg shadow-md p-6">
              ...
              {hasZeroPriceItems && (
                <div className="mb-6 bg-blue-50 border border-blue-200 rounded-lg p-4">
                  <div className="flex items-start">
                    <SvgInfo className="w-5 h-5 text-blue-600 mr-3 mt-0.5 flex-shrink-0" />
          ...
          <div className="bg-white rounded-lg shadow-md p-6 sticky top-4">
            ...
            <div className="border-t pt-4 mt-4">
              <div className="bg-blue-50 border border-blue-200 rounded-lg p-3 mb-3">
                <div className="flex items-start">
                  <SvgInfo className="w-5 h-5 text-blue-600 mr-2 mt-0.5 flex-shrink-0" />
