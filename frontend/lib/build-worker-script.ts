...
class BuildWorker {
   ...
   */
  private async executePageBuild(task: WorkerTask): Promise<any> {
   ...
   */
  private async executeAssetOptimization(task: WorkerTask): Promise<any> {
   ...
   */
  private async executeCacheOperation(task: WorkerTask): Promise<any> {
   ...
   */
  private async executeDataFetch(task: WorkerTask): Promise<any> {
...
if (workerData && parentPort) {
  try {
    new BuildWorker(workerData.config);
  } catch (error) {
