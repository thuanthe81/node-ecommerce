...
describe('PDF Cross-Service Translation Consistency', () => {
  ...
  describe('Shipping Section Translation Keys - Requirements 2.1', () => {
    ...
    it('should not contain hardcoded shipping translations in English', () => {
      const documentStructureHTML = documentStructureService.generateDocumentStructure(
        mockOrderData,
        'en',
        mockStyling
    ...
    it('should not contain hardcoded shipping translations in Vietnamese', () => {
      const documentStructureHTML = documentStructureService.generateDocumentStructure(
        mockOrderData,
        'vi',
        mockStyling
  ...
  describe('Cross-Service Translation Consistency - Requirements 2.5', () => {
    ...
    it('should use consistent translation patterns for common terms across all PDF sections', () => {
      const documentStructureHTML = documentStructureService.generateDocumentStructure(
        mockOrderData,
        'en',
        mockStyling
  ...
  describe('Translation Pattern Consistency - Requirements 2.1', () => {
    it('should use the same label:value pattern for shipping information as other sections', () => {
      const documentStructureHTML = documentStructureService.generateDocumentStructure(
        mockOrderData,
        'en',
        mockStyling
    ...
    it('should use localization service for all section titles consistently', () => {
      const documentStructureHTML = documentStructureService.generateDocumentStructure(
        mockOrderData,
        'en',
        mockStyling
